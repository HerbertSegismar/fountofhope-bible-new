      ...
      case "chapWithVerse": {
        ...
        if (ranges.length > 0) {
          parts.push(
            <Text
              key={parts.length}
              onPress={() => onNavigate(bookNum, ch, ranges)}
              style={linkStyle}
            >
              {refText}
            </Text>
